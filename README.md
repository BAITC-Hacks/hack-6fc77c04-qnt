...
Первые версии сервера Естая (`b3c498b`) и интерфейса Бекзат (`cfa205a`) объединены с сохранением обоих авторов; интегрированы README-материалы и скриншоты Бекзат (`a343e7f`). Локально прошли **100 серверных тестов**, **36 тестов frontend**, production-сборка и браузерная проверка с настоящим API. Офлайн-проверка охватила **30 600 комбинаций** по всем 100 дням каталога. Публичные релизы и границы проверки зафиксированы в [отчёте интеграции](docs/INTEGRATION_QA.md); это не обещание постоянной доступности стенда.
