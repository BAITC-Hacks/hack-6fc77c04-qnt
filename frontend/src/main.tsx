...
function App() {
 ...
 return <>
  ...
  <header><a className="brand" href="./"><span className="mark" aria-hidden="true">✳</span> QNT <span className="brand-case">/ Firebird</span></a><span className="tag">СОБЫТИЯ НАЧИНАЮТСЯ С ЛЮДЕЙ</span></header>
  <main><div className="intro"><div className="intro-copy"><p className="eyebrow">ВАШЕ СОБЫТИЕ НАЧИНАЕТСЯ ЗДЕСЬ</p><h1>Нужные люди.<br/><span>Под ваше событие.</span></h1><p>Задайте условия — получите до трёх подрядчиков<br className="desktop"/> с понятным объяснением каждого выбора.</p></div><div className="poster-stamp" aria-hidden="true"><span>ХОРОШЕЕ СОБЫТИЕ</span><b>✳</b><span>НАЧИНАЕТСЯ С ЛЮДЕЙ</span></div></div>
  <div className="layout"><section className="panel" aria-labelledby="form-title"><div className="section-title"><span className="step">01</span><h2 id="form-title">Ваше событие</h2></div>
